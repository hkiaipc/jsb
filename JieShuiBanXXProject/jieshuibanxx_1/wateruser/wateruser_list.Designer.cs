namespace jieshuibanxx_1.wateruser
{
    partial class wateruser_list
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tbcFind = new jieshuibanxx_1.Common.ToolBarCommand();
            ...
            // tbcView
            // 
            this.tbcView.CommandName = "查询";
            this.tbcView.ImagePath = null;
            this.tbcView.IsEnable = true;
            this.tbcView.IsVisible = true;
            this.tbcView.Name = "查询";
            this.tbcView.Type = jieshuibanxx_1.Common.CommandType.View;
            // 
            // tbcFind
            // 
            this.tbcFind.CommandName = "查询";
            this.tbcFind.ImagePath = null;
            this.tbcFind.IsEnable = true;
            this.tbcFind.IsVisible = true;
            this.tbcFind.Name = "查询";
            this.tbcFind.Type = jieshuibanxx_1.Common.CommandType.Find;
            // 
            // wateruser_list
            // 
            ...
            this.Name = "wateruser_list";
            this.Text = "wateruser_list";
        ...
        private jieshuibanxx_1.Common.ToolBarCommand tbcFind;
    }
}